...
const events: TimelineEvent[] = [
    ...
    { id: '2', title: 'Achievement Unlocked', description: 'First milestone reached!', timestamp: '11:30 AM', icon: starIcon, color: 'warning' },
    { id: '3', title: 'Deployment', description: 'Application deployed to production.', timestamp: '2:00 PM', icon: rocketIcon, color: 'primary' },
...
const CustomMarkers: React.FC = () => (
    <>
        <ComponentDemo title="Custom Icons & Markers" description="Use custom SVG icons in the timeline markers. Combine with markerSize for larger icons.">
