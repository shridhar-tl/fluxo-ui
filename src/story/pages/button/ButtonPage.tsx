...
const features: FeatureItem[] = [
    {
        title: 'Variants',
        description: '7 color variants: default, primary, secondary, success, warning, danger, info',
        icon: 'M9.53 16.122a3 3 0 0 0-5.78 1.128 2.25 2.25 0 0 1-2.4 2.245 4.5 4.5 0 0 0 8.4-2.245c0-.399-.078-.78-.22-1.128Zm0 0a15.998 15.998 0 0 0 3.388-1.62m-5.043-.025a15.994 15.994 0 0 1 1.622-3.395m3.42 3.42a15.995 15.995 0 0 0 4.764-4.648l3.876-5.814a1.151 1.151 0 0 0-1.597-1.597L14.146 6.32a15.996 15.996 0 0 0-4.649 4.763m3.42 3.42a6.776 6.776 0 0 0-3.42-3.42',
    },
    {
        title: 'Layouts',
        description: '5 shape styles: default, outlined, sharp, rounded (pill), and plain',
        icon: 'M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V6ZM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-2.25ZM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25a2.25 2.25 0 0 1-2.25-2.25V6Z',
    },
    {
        title: 'Sizes',
        description: '5 size options: xs, sm, md, lg, xl for every context',
        icon: 'M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15',
    },
    {
        title: 'Async Support',
        description: 'Automatically shows loading state when onClick returns a Promise',
    ...
    },
    {
        ...
        description: 'waitFor prop disables the button with a countdown for destructive actions',
        icon: 'M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z',
    },
    {
        title: 'Icon Support',
        description: 'Left and right icon slots accept any React element or icon component',
    ...
    {
        title: 'Link Mode',
        description: 'Renders as an anchor tag when href is provided, with optional newTab',
        icon: 'M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m13.35-.622 1.757-1.757a4.5 4.5 0 0 0-6.364-6.364l-4.5 4.5a4.5 4.5 0 0 0 1.242 7.244',
    },
    {
        title: 'Accessibility',
        description: 'ARIA labels, keyboard focus, role and state attributes built in',
    ...
    return (
        <PageLayout sectionNavItems={sectionNavItems}>
            ...
            <section id="import" className="scroll-mt-8">
                ...
                <CodeBlock code={`import { Button } from 'fluxo-ui';`} />
            </section>
