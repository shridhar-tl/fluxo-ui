...
const code = `import { useMobile } from 'ether-ui/hooks';
...
const UseMobileDemo: React.FC = () => {
    ...
    return (
        <>
            <ComponentDemo title="useMobile" description="Returns true when viewport width is below 768px. Automatically updates on resize.">
                <div className={cn('p-4 rounded-lg border text-center', {
                    ...
                    <p className="text-sm mt-1" style={{ color: 'var(--eui-text-muted)' }}>
                        isMobile = <code className="font-mono" style={{ color: 'var(--eui-primary)' }}>{String(isMobile)}</code>
                    </p>
