...
import _CollapsiblePanel_props_json from './../../../components/collapsible-panel/CollapsiblePanel.props.json';
const { panelProps, groupProps, tabsProps } = _CollapsiblePanel_props_json;
...
const features: FeatureItem[] = [
    {
        title: '5 Variants',
        description: 'default, bordered, elevated, ghost, and separated visual styles',
        icon: 'M9.53 16.122a3 3 0 0 0-5.78 1.128 2.25 2.25 0 0 1-2.4 2.245 4.5 4.5 0 0 0 8.4-2.245c0-.399-.078-.78-.22-1.128Zm0 0a15.998 15.998 0 0 0 3.388-1.62m-5.043-.025a15.994 15.994 0 0 1 1.622-3.395m3.42 3.42a15.995 15.995 0 0 0 4.764-4.648l3.876-5.814a1.151 1.151 0 0 0-1.597-1.597L14.146 6.32a15.996 15.996 0 0 0-4.649 4.763m3.42 3.42a6.776 6.776 0 0 0-3.42-3.42',
    },
    {
        title: '3 Sizes',
        description: 'Small, medium, and large with proportional scaling of padding and fonts',
        icon: 'M3 4.5h14.25M3 9h9.75M3 13.5h9.75m4.5-4.5v12m0 0-3.75-3.75M17.25 21 21 17.25',
    },
    {
        title: 'Accordion Mode',
        description: 'Group panels with single-open or multi-open behavior',
        icon: 'M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5',
    },
    {
        title: 'ADA Accessible',
        description: 'Full ARIA attributes, keyboard navigation, and prefers-reduced-motion support',
        icon: 'M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z',
    },
    {
        title: 'Smooth Animations',
        description: 'CSS Grid-based height animation with cubic-bezier easing for fluid transitions',
        icon: 'M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z',
    },
    {
        title: 'Custom Headers',
        description: 'Full header template support for completely custom header rendering',
        icon: 'M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 1 1-3.586-3.586l5.653-4.657m5.014-2.024a4.202 4.202 0 0 0 3.784 1.483l.037-.004a4.2 4.2 0 0 0 3.484-3.755l-.006.036a4.202 4.202 0 0 0-1.483-3.784',
    },
    {
        title: 'Horizontal Tabs',
        description: 'Side-by-side collapsible panels with rotated labels — IDE-style split panes',
        icon: 'M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15',
    },
    {
        title: 'Theming',
        description: 'Full dark/light mode and all brand themes via CSS variables — zero extra config',
        ...
        <PageLayout sectionNavItems={sectionNavItems}>
            <div>
                ...
                <p className={cn('text-base md:text-xl', { 'text-gray-400': isDark, 'text-gray-600': !isDark })}>
                    Expandable and collapsible content sections with smooth animations, multiple variants, accordion group behavior, and a
                    horizontal tabs layout for side-by-side split panes.
                </p>
            </div>
            ...
            <section id="basic" className="scroll-mt-8">
                ...
                <p className={desc}>
                    Individual panels expand and collapse with a smooth CSS Grid height animation. Each panel manages its own state or can
            ...
            <section id="sizes" className="scroll-mt-8">
                ...
                <p className={desc}>Three size presets control header padding, font size, and indicator dimensions.</p>
                <Sizes />
            </section>

            <section id="icon-positions" className="scroll-mt-8">
                <h2 className={h2}>Icon Positions</h2>
                <p className={desc}>Place the toggle chevron at the start or end of the header.</p>
                <IconPositions />
            </section>

            <section id="with-icons" className="scroll-mt-8">
                <h2 className={h2}>With Icons</h2>
                <p className={desc}>Add a leading icon to visually categorize panel content — settings, security, notifications, etc.</p>
                <WithIcons />
            </section>
            ...
            <section id="multi-open" className="scroll-mt-8">
                ...
                <p className={desc}>
                    Without the <code className="font-mono">accordion</code> prop, any number of panels can be open simultaneously. The
                    group still provides shared variant and size defaults.
                </p>
                <MultiOpenGroup />
            </section>
            ...
            <section id="header-actions" className="scroll-mt-8">
                ...
                <p className={desc}>
                    Place interactive elements (buttons, badges) at the trailing edge of the header. Click events are isolated — they do not
                    toggle the panel.
                </p>
                <HeaderActions />
            </section>
            ...
            <section id="disabled" className="scroll-mt-8">
                ...
                <p className={desc}>Disabled panels cannot be toggled. The header shows a not-allowed cursor and reduced opacity.</p>
                <DisabledState />
            </section>
            ...
            <section id="controlled" className="scroll-mt-8">
                ...
                <p className={desc}>
                    Use <code className="font-mono">open</code> and <code className="font-mono">onToggle</code> for full external control
                    over the panel state.
                </p>
                <Controlled />
            </section>
            ...
            <section id="custom-header" className="scroll-mt-8">
                ...
                <p className={desc}>
                    The <code className="font-mono">headerTemplate</code> prop gives you complete control over header rendering with access
                    to <code className="font-mono">isOpen</code> and <code className="font-mono">toggle</code>.
                </p>
            ...
            <section id="horizontal-tabs" className="scroll-mt-8">
                ...
                <p className={desc}>
                    Side-by-side collapsible panels that show rotated labels when collapsed. On mobile they stack vertically. At least one
                    tab stays open (configurable via <code className="font-mono">minOpenTabs</code>).
                </p>
                <HorizontalTabs />
            </section>
            ...
            <section id="horizontal-variants" className="scroll-mt-8">
                ...
                <p className={desc}>The horizontal tabs layout supports default, bordered, and elevated visual styles.</p>
                <HorizontalTabsVariants />
            </section>

            <section id="import" className="scroll-mt-8">
                <h2 className={h2}>Import</h2>
                <CodeBlock code={`import { CollapsiblePanel, CollapsiblePanelGroup, CollapsibleTabs } from 'fluxo-ui';`} />
            </section>
