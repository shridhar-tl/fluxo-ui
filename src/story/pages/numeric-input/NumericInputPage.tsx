...
const features: FeatureItem[] = [
    {
        ...
        description: 'Clamps the entered value within the configured min and max bounds',
        icon: 'M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15',
    },
    {
        title: 'Decimal Precision',
        description: 'Restrict the number of decimal places with the maxDecimals prop',
    ...
    },
    {
        ...
        description: 'Accepts only numeric characters; blocks letters and special chars at the input level',
    ...
    {
        title: 'Accessibility',
        description: 'Proper label association, aria-required, aria-invalid, and numeric role attributes',
    ...
    return (
        <PageLayout sectionNavItems={sectionNavItems}>
            ...
            <section id="import" className="scroll-mt-8">
                ...
                <CodeBlock code={`import { NumericInput } from 'fluxo-ui';`} />
            </section>
