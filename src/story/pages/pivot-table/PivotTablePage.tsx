...
const features: FeatureItem[] = [
    {
        ...
        description: 'Group rows by multiple fields to create a hierarchical drill-down structure.',
        icon: 'M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5',
    },
    {
        title: 'Column Pivoting',
        description: 'Pivot field values into column headers for cross-tabulation analysis.',
        icon: 'M3 4.5h14.25M3 9h9.75M3 13.5h5.25m5.25-.75L17.25 9m0 0L21 12.75M17.25 9v12',
    },
    {
        title: 'Aggregate Functions',
        description: 'Sum, average, count, min, max, product, median, distinct, and distinctCount.',
    ...
    },
    {
        ...
        description: 'Apply filters with operators like eq, neq, gt, lt, contains, and in.',
    ...
    },
    {
        ...
        description: 'Click column headers to sort data ascending, descending, or reset.',
        icon: 'M3 7.5L7.5 3m0 0L12 7.5M7.5 3v13.5m13.5 0L16.5 21m0 0L12 16.5m4.5 4.5V7.5',
    },
    {
        title: 'Custom Formatting',
        description: 'Apply custom format functions to display values as currency, percentages, or any format.',
        ...
        <PageLayout sectionNavItems={sectionNavItems}>
            <div>
                ...
                <p className={cn('text-base md:text-xl', { 'text-gray-400': isDark, 'text-gray-600': !isDark })}>
                    An interactive pivot table with drag-and-drop configuration, inline editing, custom plugins, cell templates, and 15+
                    aggregate functions.
                </p>
            </div>
            ...
            <section id="interactive" className="scroll-mt-8">
                ...
                <p className={cn('mb-4 text-sm', { 'text-gray-400': isDark, 'text-gray-500': !isDark })}>
                    Drag fields between zones (Available, Rows, Columns, Values, Filters). Change aggregation functions inline. Double-click
                    leaf cells to edit values.
                </p>
                <InteractiveDemo />
            </section>
