...
const sectionNavItems: SectionNavItem[] = [
    ...
    { id: 'controlled', title: 'Controlled & Disabled', description: 'Controlled value and disabled state' },
...
const features: FeatureItem[] = [
    {
        ...
        description: 'Cycle through any number of custom states with a single click',
    ...
    {
        title: 'Custom Icons',
        description: 'Each state can display a unique icon to visually indicate its meaning',
        icon: 'M9.53 16.122a3 3 0 0 0-5.78 1.128 2.25 2.25 0 0 1-2.4 2.245 4.5 4.5 0 0 0 8.4-2.245c0-.399-.078-.78-.22-1.128Zm0 0a15.998 15.998 0 0 0 3.388-1.62m-5.043-.025a15.994 15.994 0 0 1 1.622-3.395m3.42 3.42a15.995 15.995 0 0 0 4.764-4.648l3.876-5.814a1.151 1.151 0 0 0-1.597-1.597L14.146 6.32a15.996 15.996 0 0 0-4.649 4.763m3.42 3.42a6.776 6.776 0 0 0-3.42-3.42',
    },
    {
        title: 'Controlled',
        description: 'Fully controlled value state via the value and onChange props',
        icon: 'M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z',
    },
    {
        title: 'Keyboard Accessible',
        description: 'Supports Space and Enter keys for cycling through states',
    ...
    },
    {
        ...
        description: 'Hidden input with name attribute for seamless form submission',
        icon: 'M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25Z',
    },
    {
        title: 'Theming',
        description: 'Full dark/light mode and brand theme support via CSS variables',
...
const MultiStateCheckboxPage: React.FC = () => {
...
export default MultiStateCheckboxPage;
