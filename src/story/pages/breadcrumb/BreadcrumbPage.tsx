...
const features: FeatureItem[] = [
    {
        title: 'Auto Collapse',
        description: 'Long breadcrumb trails collapse middle items into an expandable ellipsis menu.',
        icon: 'M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12',
    },
    {
        title: 'Custom Separators',
        description: 'Use any ReactNode as a separator: text, icons, or custom elements.',
        icon: 'M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
    },
    {
        title: 'Link & Button Modes',
        description: 'Items render as anchor tags (with href) or buttons (with onClick).',
        icon: 'M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244',
    },
    {
        title: 'Active Page',
        description: 'The last item is automatically styled as the current page with aria-current.',
        icon: 'M15 10.5a3 3 0 11-6 0 3 3 0 016 0z',
    },
    {
        title: 'Icon Support',
        description: 'Each item can display an icon alongside its label.',
        icon: 'M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909',
    },
    {
        title: 'Accessibility',
        description: 'Semantic nav/ol markup with aria-label and aria-current attributes.',
