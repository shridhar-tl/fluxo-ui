...
const features: FeatureItem[] = [
    {
        ...
        description: 'Uses IntersectionObserver for efficient scroll detection without scroll event listeners.',
    ...
    {
        title: 'Error & Retry',
        description: 'Built-in error state display with a retry button to re-attempt loading.',
        icon: 'M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126z',
    },
    {
        title: 'Custom Loader',
        description: 'Replace the default spinner with any custom loading indicator.',
    ...
    {
        title: 'Inverse Mode',
        description: 'Load content at the top of the container for chat-style interfaces.',
        icon: 'M3 4.5h14.25M3 9h9.75M3 13.5h5.25m5.25-.75L17.25 9m0 0L21 12.75M17.25 9v12',
    },
    {
        title: 'Scrollable Target',
        description: 'Attach to any scrollable container by ID or element reference.',
        icon: 'M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15',
    },
    {
        title: 'End Message',
        description: 'Display a custom message when all content has been loaded.',
        ...
        <PageLayout sectionNavItems={sectionNavItems}>
            <div>
                ...
                <p className={cn('text-base md:text-xl', { 'text-gray-400': isDark, 'text-gray-600': !isDark })}>
                    An infinite scroll component that automatically loads more content as the user scrolls, with error handling and
            ...
            <section id="error-handling" className="scroll-mt-8">
                ...
                <p className={cn('mb-4 text-sm', { 'text-gray-400': isDark, 'text-gray-500': !isDark })}>
                    Pass an <code>error</code> string to show an error message with a retry button. Use <code>onRetry</code> to clear the
                    error and re-attempt loading.
                </p>
                <ErrorHandling />
            </section>
            ...
            <section id="import" className="scroll-mt-8">
                ...
                <CodeBlock code={`import { InfiniteScroll } from 'fluxo-ui';\nimport type { InfiniteScrollProps } from 'fluxo-ui';`} />
            </section>
