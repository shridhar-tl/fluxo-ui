...
const features: FeatureItem[] = [
    {
        title: 'Drag & Drop',
        description: 'Drop files directly onto the upload zone with visual hover feedback.',
        icon: 'M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5',
    },
    {
        title: 'Progress Tracking',
        description: 'Real-time upload progress bars for each file being uploaded.',
    ...
    },
    {
        ...
        description: 'Automatic thumbnail generation for uploaded image files.',
    ...
    },
    {
        ...
        description: 'Built-in type and size validation plus custom validator support.',
        icon: 'M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
    },
    {
        title: 'Multiple Files',
        description: 'Upload multiple files at once with configurable file count limits.',
        icon: 'M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z',
    },
    {
        title: 'Accessibility',
        description: 'Keyboard accessible with ARIA labels and role attributes.',
    ...
    return (
        <PageLayout sectionNavItems={sectionNavItems}>
            ...
            <section id="import" className="scroll-mt-8">
                ...
                <CodeBlock code={`import { FileUpload } from 'fluxo-ui';`} />
            </section>
