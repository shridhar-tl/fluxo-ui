...
const sectionNavItems: SectionNavItem[] = [
    ...
    { id: 'indeterminate', title: 'Indeterminate', description: 'Partial selection state' },
    { id: 'states', title: 'States', description: 'Normal, disabled, required' },
...
const features: FeatureItem[] = [
    {
        title: 'Controlled',
        description: 'Fully controlled checked state via the checked and onChange props',
        icon: 'M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z',
    },
    { title: 'Indeterminate', description: 'Built-in indeterminate state for partial selection in tree structures', icon: 'M5 12h14' },
    {
        title: 'Disabled',
        description: 'Disabled state prevents interaction while preserving checked value',
        icon: 'M18.364 18.364A9 9 0 0 0 5.636 5.636m12.728 12.728A9 9 0 0 1 5.636 5.636m12.728 12.728L5.636 5.636',
    },
    {
        title: 'Label Support',
        description: 'Inline label prop with correct for/id association for accessibility',
        icon: 'M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12',
    },
    {
        title: 'Form Integration',
        description: 'name and args props for form submission and event identification',
        icon: 'M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25Z',
    },
    {
        title: 'Accessibility',
        description: 'Native checkbox semantics with ARIA support for screen readers',
...
const CheckboxPage: React.FC = () => {
    ...
    return (
        <PageLayout sectionNavItems={sectionNavItems}>
            ...
            <section className="scroll-mt-8" id="group">
                <h2 className={cn('text-2xl font-semibold mb-4', { 'text-gray-100': isDark, 'text-gray-900': !isDark })}>Checkbox Group</h2>
                <CheckboxGroup />
            </section>

            <section className="scroll-mt-8" id="indeterminate">
            ...
            <section className="scroll-mt-8" id="import">
                ...
                <CodeBlock code={`import { Checkbox } from 'fluxo-ui';`} />
            </section>
