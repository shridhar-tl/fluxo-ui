...
const stepperProps = {
    ...
    layout: { type: "'default' | 'rounded' | 'square' | 'rectangle' | 'dot' | 'minimal'", default: "'default'", description: 'Shape of step indicators' },
    orientation: { type: "'horizontal' | 'vertical'", default: "'horizontal'", description: 'Layout direction' },
    labelPlacement: { type: "'bottom' | 'right' | 'alternate'", default: "'bottom'", description: 'Position of labels relative to indicators' },
...
const features: FeatureItem[] = [
    { title: 'Multiple Layouts', description: 'Six indicator shapes: default rounded-rect, circle, square, rectangle pill, dot, and minimal text-only', icon: 'M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V6ZM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-2.25ZM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25a2.25 2.25 0 0 1-2.25-2.25V6ZM13.5 15.75a2.25 2.25 0 0 1 2.25-2.25H18a2.25 2.25 0 0 1 2.25 2.25V18A2.25 2.25 0 0 1 18 20.25h-2.25a2.25 2.25 0 0 1-2.25-2.25v-2.25Z' },
    { title: 'Custom Icons', description: 'Pass custom icons per step for active, completed, and default states', icon: 'M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z' },
    { title: 'Vertical & Horizontal', description: 'Both orientations with automatic connector adjustment', icon: 'M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15' },
    { title: 'Interactive Navigation', description: 'Clickable steps with optional linear restriction for wizard flows', icon: 'M15.042 21.672 13.684 16.6m0 0-2.51 2.225.569-9.47 5.227 7.917-3.286-.672ZM12 2.25V4.5m5.834.166-1.591 1.591M20.25 10.5H18M7.757 14.743l-1.59 1.59M6 10.5H3.75m4.007-4.243-1.59-1.59' },
    { title: 'Step Status', description: 'Individual step status with error, warning, completed, active, and pending states', icon: 'M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z' },
    { title: 'Label Placement', description: 'Labels can be placed below, to the right, or alternating above/below', icon: 'M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5' },
];
...
const StepperPage: React.FC = () => {
    ...
    return (
        <PageLayout sectionNavItems={sectionNavItems}>
            <div>
                <h1 className={cn('text-2xl md:text-4xl font-bold mb-4', { 'text-gray-100': isDark, 'text-gray-900': !isDark })}>Stepper</h1>
            ...
            <section id="label-placement" className="scroll-mt-8">
                <h2 className={cn('text-2xl font-semibold mb-4', { 'text-gray-100': isDark, 'text-gray-900': !isDark })}>Label Placement</h2>
                <LabelPlacement />
            </section>
            ...
            <section id="import" className="scroll-mt-8">
                ...
                <CodeBlock code={`import { Stepper } from 'ether-ui';\nimport type { StepItem } from 'ether-ui';`} />
            </section>
