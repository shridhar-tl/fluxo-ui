...
import { PhoneNumber, DateInput, TimeInput, SsnInput, CreditCard, Ipv4Address, LicensePlate } from './MaskExamples';
...
const maskedInputProps = {
    mask: { type: 'string', description: "Mask pattern. Use '9' for digit, 'a' for letter, '*' for alphanumeric, any other char as literal separator" },
    ...
    onRawChange: { type: '(raw: string, masked: string) => void', description: 'Called with the raw (unmasked) value alongside the masked display value' },
    slotChar: { type: 'string', default: '_', description: 'Character shown for empty mask slots' },
    includeLiterals: { type: 'boolean', default: true, description: 'Whether to include literal separator characters in the onChange value' },
...
const features: FeatureItem[] = [
    { title: 'Flexible Mask Syntax', description: "Use '9' for digits, 'a' for letters, '*' for alphanumeric, and any other char as a fixed separator", icon: 'M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12' },
    { title: 'Raw Value Access', description: 'onRawChange gives you the unformatted value alongside the masked display string', icon: 'M7.5 21 3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5' },
    { title: 'Pre-filled Values', description: 'Pass a raw or masked value at mount time and the component normalises it automatically', icon: 'M16.862 4.487l1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10' },
    { title: 'Custom Slot Character', description: 'Replace the default underscore placeholder for empty slots with any character', icon: 'M9.75 9.75l4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z' },
    { title: 'Keyboard Navigation', description: 'Arrow keys, Home, End, Backspace, Delete, and paste all work with slot-aware behaviour', icon: 'M9 17.25v1.007a3 3 0 0 1-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0 1 15 18.257V17.25m6-12V15a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 15V5.25m18 0A2.25 2.25 0 0 0 18.75 3H5.25A2.25 2.25 0 0 0 3 5.25m18 0H3' },
    { title: 'includeLiterals Control', description: 'Choose whether onChange emits separators (e.g. dashes, spaces) or raw characters only', icon: 'M10.5 6h9.75M10.5 6a1.5 1.5 0 1 1-3 0m3 0a1.5 1.5 0 1 0-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-9.75 0h9.75' },
    { title: 'Accessibility', description: 'Keyboard-only operable, ARIA attributes, and screen-reader-friendly slot announcements', icon: 'M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z' },
...
const MaskedInputPage: React.FC = () => {
    ...
    return (
        <PageLayout sectionNavItems={sectionNavItems}>
            <div>
                <h1 className={cn('text-2xl md:text-4xl font-bold mb-4', { 'text-gray-100': isDark, 'text-gray-900': !isDark })}>MaskedInput</h1>
                <p className={cn('text-base md:text-xl', { 'text-gray-400': isDark, 'text-gray-600': !isDark })}>
                    A controlled text input that enforces a character-by-character mask pattern. Supports digits, letters,
                    alphanumeric slots, and arbitrary literal separators with full keyboard navigation.
                </p>
            </div>
            ...
            <section id="import" className="scroll-mt-8">
                ...
                <CodeBlock code={`import { MaskedInput } from 'ether-ui';`} />
            </section>
