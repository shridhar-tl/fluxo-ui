...
const features: FeatureItem[] = [
    ...
    },
    {
        ...
        description: 'Attach to onContextMenu for classic right-click behavior or to onClick for button-triggered dropdown-style menus.',
    ...
    {
        title: 'Scrollable Long Menus',
        description: 'Menus with many items automatically become scrollable with hover-triggered arrow controls — no scrollbar clutter.',
        icon: 'M3 7.5 7.5 3m0 0L12 7.5M7.5 3v13.5m13.5 0L16.5 21m0 0L12 16.5m4.5 4.5V7.5',
    },
    {
        title: 'Separators',
        description: 'Add visual dividers between menu groups by including an item with seperator: true to logically organize actions.',
        icon: 'M3.75 9h16.5m-16.5 6.75h16.5',
    },
    {
        title: 'Icon Support',
        description: 'Each menu item supports an icon prop that accepts any ReactNode — use any icon component or custom SVG element.',
    ...
    {
        title: 'Smart Viewport Positioning',
        description:
    ...
    return (
        <PageLayout sectionNavItems={sectionNavItems}>
            ...
            <section className="scroll-mt-8" id="import">
                ...
                <CodeBlock code={`import { ContextMenuManager, showContextMenu } from 'fluxo-ui';`} />
            </section>
            ...
            <section className="scroll-mt-8" id="api-reference">
                ...
                <h3 className={cn('text-lg font-semibold mt-6 mb-3', { 'text-gray-100': isDark, 'text-gray-900': !isDark })}>
