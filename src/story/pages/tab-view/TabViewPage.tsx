...
const tabViewProps = {
    ...
    variant: {
        type: "'default' | 'pills' | 'enclosed' | 'segment' | 'editor' | 'thick-border' | 'elevated'",
        default: "'default'",
...
const features: FeatureItem[] = [
    {
        ...
        description: 'Seven visual styles: default, pills, enclosed, segment (iOS), editor (VS Code), thick-border, and elevated.',
