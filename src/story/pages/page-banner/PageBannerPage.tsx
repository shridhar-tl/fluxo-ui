...
import _PageBanner_props_json from './../../../components/page-banner/PageBanner.props.json';
const { pageBannerProps } = _PageBanner_props_json;
...
const features: FeatureItem[] = [
    {
        title: 'Five Banner Types',
        description: 'Info, success, warning, error, and default types with distinct colors and icons.',
    ...
    {
        title: 'Dismissible',
        description: 'Banners can be dismissed manually via close button or automatically after a timer.',
        icon: 'M6 18L18 6M6 6l12 12',
    },
    {
        title: 'Auto-Dismiss',
        description: 'Set a timer with a progress bar indicator that auto-dismisses the banner.',
        icon: 'M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z',
    },
    {
        title: 'Page-Level Portal',
        description: 'Render banners at the top of the page using createPortal for global notifications.',
        icon: 'M3 4.5h14.25M3 9h9.75M3 13.5h9.75m4.5-4.5v12m0 0l-3.75-3.75M17.25 21L21 17.25',
    },
    {
        title: 'Action Buttons',
        description: 'Include action buttons alongside the message for immediate user interaction.',
    ...
    {
        title: 'Accessible',
        description: 'Uses role="alert" and aria-live="polite" for screen reader compatibility.',
        ...
        <PageLayout sectionNavItems={sectionNavItems}>
            <div>
                ...
                <p className={cn('text-base md:text-xl', { 'text-gray-400': isDark, 'text-gray-600': !isDark })}>
                    A versatile notification banner component with multiple types, dismissible behavior, auto-dismiss timers, page-level
                    portals, and action buttons.
                </p>
            </div>
            ...
            <section id="page-level" className="scroll-mt-8">
                ...
                <p className={cn('mb-4 text-sm', { 'text-gray-400': isDark, 'text-gray-500': !isDark })}>
                    Use <code>pageLevel</code> to render the banner at the top of the page via createPortal, or <code>bordered</code> for a
                    left accent border.
                </p>
                <PageLevel />
            </section>
