...
const sectionNavItems: SectionNavItem[] = [
    ...
    { id: 'states', title: 'States', description: 'Disabled state' },
...
const features: FeatureItem[] = [
    {
        title: 'Add & Remove',
        description: 'Type and press Enter or comma to add chips; click x to remove any chip',
        icon: 'M12 4.5v15m7.5-7.5h-15',
    },
    {
        title: 'Max Items',
        description: 'Optionally cap the number of chips with the maxItems prop',
        icon: 'M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15',
    },
    {
        title: 'Duplicate Control',
        description: 'Allow or prevent duplicate entries via the allowDuplicates prop',
    ...
    },
    {
        ...
        description: 'Define which character splits a pasted or typed string into multiple chips',
        icon: 'M7.5 21 3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5',
    },
    {
        title: 'Disabled & Readonly',
        description: 'Fully supports disabled (no interaction) and readonly (display-only) modes',
        icon: 'M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z',
    },
    {
        title: 'Accessibility',
        description: 'Keyboard navigation, ARIA roles and labels for screen reader support',
...
const ChipsPage: React.FC = () => {
    ...
    return (
        <PageLayout sectionNavItems={sectionNavItems}>
            <div>
                <h1 className={cn('text-2xl md:text-4xl font-bold mb-4', { 'text-gray-100': isDark, 'text-gray-900': !isDark })}>Chips</h1>
            ...
            <section id="limited" className="scroll-mt-8">
                <h2 className={cn('text-2xl font-semibold mb-4', { 'text-gray-100': isDark, 'text-gray-900': !isDark })}>Limited Chips</h2>
                <LimitedChips />
            </section>
            ...
            <section id="import" className="scroll-mt-8">
                ...
                <CodeBlock code={`import { Chips } from 'fluxo-ui';`} language="typescript" />
            </section>
