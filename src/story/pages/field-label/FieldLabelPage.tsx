...
const advancedUsageCode = `import { FieldLabel, TextInput } from 'fluxo-ui';
...
const features: FeatureItem[] = [
    {
        ...
        description: 'Shows a visual asterisk marker for required form fields',
        icon: 'M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z',
    },
    {
        title: 'Optional Indicator',
        description: 'Displays an "(optional)" badge for non-mandatory fields',
    ...
    {
        title: 'Error State',
        description: 'Applies error styling and color to indicate invalid input',
        icon: 'M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z',
    },
    {
        title: 'Disabled State',
        description: 'Muted styling for disabled or read-only form fields',
        icon: 'M18.364 18.364A9 9 0 0 0 5.636 5.636m12.728 12.728A9 9 0 0 1 5.636 5.636m12.728 12.728L5.636 5.636',
    },
    {
        title: 'Accessibility',
        description: 'htmlFor prop properly associates labels with form controls for screen readers',
