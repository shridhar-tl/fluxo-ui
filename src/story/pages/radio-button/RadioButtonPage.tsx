...
const features: FeatureItem[] = [
    {
        ...
        description: 'Enforces exactly one selection at a time from a set of mutually exclusive options',
        icon: 'M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z',
    },
    {
        title: 'Vertical & Horizontal',
        description: 'Supports both vertical (stacked) and horizontal (inline) orientations via the orientation prop',
        icon: 'M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5',
    },
    {
        title: 'Per-Item Disabled',
        description: 'Individual items can be disabled independently while the rest of the group remains interactive',
        icon: 'M18.364 18.364A9 9 0 0 0 5.636 5.636m12.728 12.728A9 9 0 0 1 5.636 5.636m12.728 12.728L5.636 5.636',
    },
    {
        title: 'Full Group Disable',
        description: 'The disabled prop disables all radio buttons in the group at once for easy form-level control',
        icon: 'M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z',
    },
    {
        title: 'Validation Support',
        description: 'Built-in required and error props for form validation with visible error message display',
        icon: 'M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z',
    },
    {
        title: 'Controlled Component',
        description: 'Fully controlled via value and onChange — works as both controlled and uncontrolled inputs',
    ...
    {
        title: 'Accessibility',
        description: 'Uses native radio input semantics with proper grouping, keyboard navigation, and ARIA labels',
    ...
    return (
        <PageLayout sectionNavItems={sectionNavItems}>
            ...
            <section id="import" className="scroll-mt-8">
                ...
                <CodeBlock code={`import { RadioButtonGroup } from 'fluxo-ui';`} />
            </section>
