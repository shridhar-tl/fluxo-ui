...
const features: FeatureItem[] = [
    {
        ...
        description: 'Rendered via React portals so modals always appear above all other content',
        icon: 'M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15',
    },
    {
        title: 'Multiple Sizes',
        description: 'Four preset widths — sm, md, lg, xl — to fit any content need',
        icon: 'M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15',
    },
    {
        title: 'Scrollable Body',
        description: 'Content area scrolls independently while the footer stays fixed on screen',
        icon: 'M3 4.5h14.25M3 9h9.75M3 13.5h9.75m4.5-4.5v12m0 0-3.75-3.75M17.25 21 21 17.25',
    },
    {
        title: 'Sticky Footer',
        description: 'Optional footer prop always visible at the bottom, even with long content',
        icon: 'M3 4.5h14.25M3 9h9.75M3 13.5h5.25m5.25-.75L17.25 9m0 0L21 12.75M17.25 9v12',
    },
    {
        title: 'Keyboard Support',
        description: 'Escape key closes the modal; focus is trapped inside while open',
    ...
    },
    {
        ...
        description: 'closeOnBackdrop prop disables click-outside for critical confirmations',
        icon: 'M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z',
    },
    {
        title: 'Nested Modals',
        description: 'Multiple modals can be stacked with independent close handlers',
    ...
    {
        title: 'Scroll Lock',
        description: 'Body scrolling is locked while the modal is open to prevent background movement',
        icon: 'M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z',
    },
    {
        title: 'Smooth Animations',
        description: 'Scale and opacity transitions on open and close for a polished feel',
        icon: 'M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75Z',
    },
    {
        title: 'Accessibility',
        description: 'ARIA dialog role, focus management, and screen reader labels built in',
        ...
        <PageLayout sectionNavItems={sectionNavItems}>
            <div>
                ...
                <p className={cn('text-base md:text-xl', { 'text-gray-400': isDark, 'text-gray-600': !isDark })}>
                    A dialog component that displays content in a layer above the main application. Modals can be used for confirmations,
                    forms, detailed information, or any content that requires focused user attention.
                </p>
            </div>
            ...
            <section className="scroll-mt-8" id="import">
                ...
                <CodeBlock code={`import { Modal } from 'fluxo-ui';`} />
            </section>
