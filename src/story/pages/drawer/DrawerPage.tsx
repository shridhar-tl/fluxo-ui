...
const features: FeatureItem[] = [
    {
        ...
        description: 'Slide in from left, right, top, or bottom with smooth CSS transitions.',
        icon: 'M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15',
    },
    {
        title: 'Focus Trap',
        description: 'Tab key cycles through focusable elements within the drawer.',
        icon: 'M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z',
    },
    {
        title: 'Push Content',
        description: 'Optionally push main content aside instead of overlaying.',
        icon: 'M9 8.25H7.5a2.25 2.25 0 00-2.25 2.25v9a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25H15M9 12l3 3m0 0l3-3m-3 3V2.25',
    },
    {
        title: 'Header & Footer',
        description: 'Optional header with close button and footer for action buttons.',
    ...
    },
    {
        ...
        description: 'Toggle backdrop visibility and close-on-click behavior.',
        icon: 'M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909',
    },
    {
        title: 'Accessibility',
        description: 'ARIA modal role, focus restoration, and escape key handling.',
