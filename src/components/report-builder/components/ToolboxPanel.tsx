...
const toolboxItems: ToolboxItem[] = [
    ...
    { type: 'repeater', label: 'Repeater', icon: RepeaterIcon, category: 'Layout' },
    ...
    { type: 'chart-horizontal-bar', label: 'Horizontal Bar', icon: HorizontalBarChartIcon, category: 'Charts' },
    { type: 'chart-stacked-bar', label: 'Stacked Bar', icon: StackedBarChartIcon, category: 'Charts' },
    { type: 'chart-line', label: 'Line Chart', icon: LineChartUpIcon, category: 'Charts' },
    { type: 'chart-area', label: 'Area Chart', icon: AreaChartIcon, category: 'Charts' },
    ...
    { type: 'chart-polar-area', label: 'Polar Area', icon: PolarChartIcon, category: 'Charts' },
    { type: 'chart-radar', label: 'Radar Chart', icon: RadarChartIcon, category: 'Charts' },
    { type: 'chart-scatter', label: 'Scatter Plot', icon: ScatterChartIcon, category: 'Charts' },
    { type: 'chart-bubble', label: 'Bubble Chart', icon: BubbleChartIcon, category: 'Charts' },
];
